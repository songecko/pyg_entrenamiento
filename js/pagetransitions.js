var PageTransitions = (function() {
	...
	function goToPage( pageIndex, animation ) {
	...
	{
		var pageTitleText = page.children('p.pageTitleHolder:first-child').html();
